                ...
                <a href="{{ $article->url }}" class="no-underline">
                    <div class="py-4 flex border-solid border-t-0 border-r-0 border-l-0 mb-3" style="border-color: #dfe1e5">
                        <div class="w-2/3" dir="rtl">
                            <div><h3 class="text-gray-800 my-0">{{ htmlspecialchars_decode(html_entity_decode($article->title),ENT_QUOTES) }}</h3></div>
                            <div class="mb-3"><p class="text-gray-700">{{ htmlspecialchars_decode(html_entity_decode($article->description),ENT_QUOTES) }}</p></div>
                            <div>
